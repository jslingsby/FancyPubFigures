...
#Set variabels
Scholar_ID <- "ZjBauSkAAAAJ" 
# this is your author scholar Id, it'll be found in the address of your scholar profile after user=and before &, https://scholar.google.com/citations?user=ZjBauSkAAAAJ&hl=en
Author_fullname<- c("Jasper Slingsby","Jasper A Slingsby") #full name as it appears in articles in pubmed
Author_lastname<-c("Slingsby") #last name and alternative spellings
...
#get impact factor
IF<-get_journalrank(df$journal) #get impact factor for journals, some might not be accurate and may require to be changed manually
...
#df<-df[df$year>=2009,]
#Plot
p1v1<-ggplot(df,aes(y=SJR,x=year))+
